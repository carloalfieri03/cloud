...
class ModelLabAPIApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listModelLabProjects(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ModelLabProjectsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 || response.httpStatusCode === 500) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listModelLabRunArtifacts(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ModelLabRunArtifactsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 404 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listModelLabRunFacetKeys(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ModelLabFacetKeysResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listModelLabRunFacetValues(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ModelLabFacetValuesResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listModelLabRuns(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ModelLabRunsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 || response.httpStatusCode === 500) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    unstarModelLabProject(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
...
exports.ModelLabAPIApiResponseProcessor = ModelLabAPIApiResponseProcessor;
class ModelLabAPIApi {
     ...
     */
    deleteModelLabRun(param, options) {
     ...
     * @param param The request object
     */
    getModelLabArtifactContent(param, options) {
     ...
     * @param param The request object
     */
    getModelLabProject(param, options) {
     ...
     * @param param The request object
     */
    listModelLabProjectArtifacts(param, options) {
     ...
     * @param param The request object
     */
    listModelLabProjectFacetKeys(options) {
     ...
     * @param param The request object
     */
    listModelLabProjectFacetValues(param, options) {
     ...
     * @param param The request object
     */
    listModelLabProjects(param = {}, options) {
     ...
     * @param param The request object
     */
    listModelLabRunArtifacts(param, options) {
     ...
     * @param param The request object
     */
    listModelLabRunFacetKeys(param, options) {
     ...
     * @param param The request object
     */
    listModelLabRunFacetValues(param, options) {
     ...
     * @param param The request object
     */
    listModelLabRuns(param = {}, options) {
     ...
     * @param param The request object
     */
    starModelLabProject(param, options) {
     ...
     * @param param The request object
     */
    unpinModelLabRun(param, options) {
     ...
     * @param param The request object
     */
    unstarModelLabProject(param, options) {
...
exports.ModelLabAPIApi = ModelLabAPIApi;
//# sourceMappingURL=ModelLabAPIApi.js.map