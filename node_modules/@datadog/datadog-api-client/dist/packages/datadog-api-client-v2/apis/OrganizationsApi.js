...
class OrganizationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    getSAMLConfiguration(samlConfigUuid, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'samlConfigUuid' is not null or undefined
            if (samlConfigUuid === null || samlConfigUuid === undefined) {
                throw new baseapi_1.RequiredError("samlConfigUuid", "getSAMLConfiguration");
            }
            // Path Params
            const localVarPath = "/api/v2/saml_configurations/{saml_config_uuid}".replace("{saml_config_uuid}", encodeURIComponent(String(samlConfigUuid)));
            // Make Request Context
            const requestContext = _config
    ...
    listGlobalOrgs(userHandle, pageLimit, pageCursor, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'userHandle' is not null or undefined
            if (userHandle === null || userHandle === undefined) {
                throw new baseapi_1.RequiredError("userHandle", "listGlobalOrgs");
            }
            // Path Params
            ...
            if (userHandle !== undefined) {
                requestContext.setQueryParam("user_handle", ObjectSerializer_1.ObjectSerializer.serialize(userHandle, "string", ""), "");
            }
    ...
    listSAMLConfigurations(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
    ...
    updateLoginOrgConfigsMaxSessionDuration(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateLoginOrgConfigsMaxSessionDuration");
            }
            // Path Params
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "MaxSessionDurationUpdateRequest", ""), contentType);
    ...
    updateOrgSamlConfigurations(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'updateOrgSamlConfigurations'");
            ...
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateOrgSamlConfigurations");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "OrgSAMLPreferencesUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    updateSAMLConfiguration(samlConfigUuid, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'samlConfigUuid' is not null or undefined
            if (samlConfigUuid === null || samlConfigUuid === undefined) {
                throw new baseapi_1.RequiredError("samlConfigUuid", "updateSAMLConfiguration");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateSAMLConfiguration");
            }
            // Path Params
            const localVarPath = "/api/v2/saml_configurations/{saml_config_uuid}".replace("{saml_config_uuid}", encodeURIComponent(String(samlConfigUuid)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "SAMLConfigurationUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class OrganizationsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getSAMLConfiguration(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SAMLConfigurationResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listGlobalOrgs(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "GlobalOrgsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
    ...
    listOrgs(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ManagedOrgsResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listSAMLConfigurations(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SAMLConfigurationsResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateLoginOrgConfigsMaxSessionDuration(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateOrgSamlConfigurations(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateSAMLConfiguration(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SAMLConfigurationResponse");
...
class OrganizationsApi {
     ...
     * @param param The request object
     */
    getSAMLConfiguration(param, options) {
     ...
     */
    listGlobalOrgsWithPagination(param, options) {
        return __asyncGenerator(this, arguments, function* listGlobalOrgsWithPagination_1() {
            let pageSize = 100;
            ...
            while (true) {
                const requestContext = yield __await(this.requestFactory.listGlobalOrgs(param.userHandle, param.pageLimit, param.pageCursor, options));
                const responseContext = yield __await(this.configuration.httpApi.send(requestContext));
                const response = yield __await(this.responseProcessor.listGlobalOrgs(responseContext));
     ...
     * @param param The request object
     */
    listSAMLConfigurations(options) {
     ...
     * @param param The request object
     */
    updateLoginOrgConfigsMaxSessionDuration(param, options) {
     ...
     * @param param The request object
     */
    updateOrgSamlConfigurations(param, options) {
     ...
     * @param param The request object
     */
    updateSAMLConfiguration(param, options) {
