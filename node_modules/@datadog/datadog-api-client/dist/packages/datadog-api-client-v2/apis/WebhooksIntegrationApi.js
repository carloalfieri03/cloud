...
class WebhooksIntegrationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    createOAuth2ClientCredentials(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createOAuth2ClientCredentials");
            }
            // Path Params
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "WebhooksOAuth2ClientCredentialsCreateRequest", ""), contentType);
    ...
    deleteOAuth2ClientCredentials(authMethodId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'authMethodId' is not null or undefined
            if (authMethodId === null || authMethodId === undefined) {
                throw new baseapi_1.RequiredError("authMethodId", "deleteOAuth2ClientCredentials");
            }
            // Path Params
            const localVarPath = "/api/v2/integration/webhooks/configuration/auth-method/oauth2-client-credentials/{auth_method_id}".replace("{auth_method_id}", encodeURIComponent(String(authMethodId)));
            // Make Request Context
            const requestContext = _config
    ...
    getAllAuthMethods(include, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            ...
            if (include !== undefined) {
                requestContext.setQueryParam("include", ObjectSerializer_1.ObjectSerializer.serialize(include, "WebhooksAuthMethodProtocol", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    getOAuth2ClientCredentials(authMethodId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'authMethodId' is not null or undefined
            if (authMethodId === null || authMethodId === undefined) {
                throw new baseapi_1.RequiredError("authMethodId", "getOAuth2ClientCredentials");
            }
            // Path Params
            const localVarPath = "/api/v2/integration/webhooks/configuration/auth-method/oauth2-client-credentials/{auth_method_id}".replace("{auth_method_id}", encodeURIComponent(String(authMethodId)));
            // Make Request Context
    ...
    updateOAuth2ClientCredentials(authMethodId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'authMethodId' is not null or undefined
            if (authMethodId === null || authMethodId === undefined) {
                throw new baseapi_1.RequiredError("authMethodId", "updateOAuth2ClientCredentials");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateOAuth2ClientCredentials");
            }
            // Path Params
            const localVarPath = "/api/v2/integration/webhooks/configuration/auth-method/oauth2-client-credentials/{auth_method_id}".replace("{auth_method_id}", encodeURIComponent(String(authMethodId)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "WebhooksOAuth2ClientCredentialsUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class WebhooksIntegrationApiResponseProcessor {
     ...
     */
    createOAuth2ClientCredentials(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "WebhooksOAuth2ClientCredentialsResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteOAuth2ClientCredentials(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getAllAuthMethods(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "WebhooksAuthMethodsResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getOAuth2ClientCredentials(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "WebhooksOAuth2ClientCredentialsResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateOAuth2ClientCredentials(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "WebhooksOAuth2ClientCredentialsResponse");
...
class WebhooksIntegrationApi {
     ...
     */
    createOAuth2ClientCredentials(param, options) {
     ...
     * @param param The request object
     */
    deleteOAuth2ClientCredentials(param, options) {
     ...
     * @param param The request object
     */
    getAllAuthMethods(param = {}, options) {
     ...
     * @param param The request object
     */
    getOAuth2ClientCredentials(param, options) {
     ...
     * @param param The request object
     */
    updateOAuth2ClientCredentials(param, options) {
