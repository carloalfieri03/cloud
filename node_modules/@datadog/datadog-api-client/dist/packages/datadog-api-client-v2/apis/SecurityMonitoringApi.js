...
class SecurityMonitoringApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    attachServiceNowTicket(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'attachServiceNowTicket'");
            if (!_config.unstableOperations["v2.attachServiceNowTicket"]) {
                throw new Error("Unstable operation 'attachServiceNowTicket' is disabled");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
    ...
    createServiceNowTickets(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'createServiceNowTickets'");
            if (!_config.unstableOperations["v2.createServiceNowTickets"]) {
                throw new Error("Unstable operation 'createServiceNowTickets' is disabled");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
