...
class RUMApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    deleteSourcemaps(mapkind, dryRun, filterService, filterVersion, filterVariant, filterId, filterBuildId, filterUuid, filterPlatform, filterBuildNumber, filterBundleName, filterArch, filterSymbolSource, filterOrigin, filterOriginVersion, filterFilename, filterDebugId, filterGnuBuildId, filterGoBuildId, filterFileHash, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'deleteSourcemaps'");
            ...
            if (mapkind === null || mapkind === undefined) {
                throw new baseapi_1.RequiredError("mapkind", "deleteSourcemaps");
            }
            // verify required parameter 'dryRun' is not null or undefined
            if (dryRun === null || dryRun === undefined) {
                throw new baseapi_1.RequiredError("dryRun", "deleteSourcemaps");
            }
            // Path Params
            ...
            if (mapkind !== undefined) {
                requestContext.setQueryParam("mapkind", ObjectSerializer_1.ObjectSerializer.serialize(mapkind, "SourcemapMapKind", ""), "");
            }
            if (dryRun !== undefined) {
                requestContext.setQueryParam("dry_run", ObjectSerializer_1.ObjectSerializer.serialize(dryRun, "boolean", ""), "");
            }
            if (filterService !== undefined) {
                requestContext.setQueryParam("filter[service]", ObjectSerializer_1.ObjectSerializer.serialize(filterService, "Array<string>", ""), "multi");
            }
            if (filterVersion !== undefined) {
                requestContext.setQueryParam("filter[version]", ObjectSerializer_1.ObjectSerializer.serialize(filterVersion, "Array<string>", ""), "multi");
            }
            if (filterVariant !== undefined) {
                requestContext.setQueryParam("filter[variant]", ObjectSerializer_1.ObjectSerializer.serialize(filterVariant, "Array<string>", ""), "multi");
            }
            if (filterId !== undefined) {
                requestContext.setQueryParam("filter[id]", ObjectSerializer_1.ObjectSerializer.serialize(filterId, "Array<string>", ""), "multi");
            }
            if (filterBuildId !== undefined) {
                requestContext.setQueryParam("filter[build_id]", ObjectSerializer_1.ObjectSerializer.serialize(filterBuildId, "Array<string>", ""), "multi");
            }
            if (filterUuid !== undefined) {
                requestContext.setQueryParam("filter[uuid]", ObjectSerializer_1.ObjectSerializer.serialize(filterUuid, "Array<string>", ""), "multi");
            }
            if (filterPlatform !== undefined) {
                requestContext.setQueryParam("filter[platform]", ObjectSerializer_1.ObjectSerializer.serialize(filterPlatform, "Array<string>", ""), "multi");
            }
            if (filterBuildNumber !== undefined) {
                requestContext.setQueryParam("filter[build_number]", ObjectSerializer_1.ObjectSerializer.serialize(filterBuildNumber, "Array<string>", ""), "multi");
            }
            if (filterBundleName !== undefined) {
                requestContext.setQueryParam("filter[bundle_name]", ObjectSerializer_1.ObjectSerializer.serialize(filterBundleName, "Array<string>", ""), "multi");
            }
            if (filterArch !== undefined) {
                requestContext.setQueryParam("filter[arch]", ObjectSerializer_1.ObjectSerializer.serialize(filterArch, "Array<string>", ""), "multi");
            }
            if (filterSymbolSource !== undefined) {
                requestContext.setQueryParam("filter[symbol_source]", ObjectSerializer_1.ObjectSerializer.serialize(filterSymbolSource, "Array<string>", ""), "multi");
            }
            if (filterOrigin !== undefined) {
                requestContext.setQueryParam("filter[origin]", ObjectSerializer_1.ObjectSerializer.serialize(filterOrigin, "Array<string>", ""), "multi");
            }
            if (filterOriginVersion !== undefined) {
                requestContext.setQueryParam("filter[origin_version]", ObjectSerializer_1.ObjectSerializer.serialize(filterOriginVersion, "Array<string>", ""), "multi");
            }
            if (filterFilename !== undefined) {
                requestContext.setQueryParam("filter[filename]", ObjectSerializer_1.ObjectSerializer.serialize(filterFilename, "string", ""), "");
            }
            if (filterDebugId !== undefined) {
                requestContext.setQueryParam("filter[debug_id]", ObjectSerializer_1.ObjectSerializer.serialize(filterDebugId, "string", ""), "");
            }
            if (filterGnuBuildId !== undefined) {
                requestContext.setQueryParam("filter[gnu_build_id]", ObjectSerializer_1.ObjectSerializer.serialize(filterGnuBuildId, "string", ""), "");
            }
            if (filterGoBuildId !== undefined) {
                requestContext.setQueryParam("filter[go_build_id]", ObjectSerializer_1.ObjectSerializer.serialize(filterGoBuildId, "string", ""), "");
            }
            if (filterFileHash !== undefined) {
                requestContext.setQueryParam("filter[file_hash]", ObjectSerializer_1.ObjectSerializer.serialize(filterFileHash, "string", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    getServiceRepositoryInfo(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getServiceRepositoryInfo'");
            ...
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "getServiceRepositoryInfo");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "ServiceRepositoryInfoRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    getSourcemaps(filename, service, version, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getSourcemaps'");
            ...
            if (filename === null || filename === undefined) {
                throw new baseapi_1.RequiredError("filename", "getSourcemaps");
            }
            // verify required parameter 'service' is not null or undefined
            if (service === null || service === undefined) {
                throw new baseapi_1.RequiredError("service", "getSourcemaps");
            }
            // verify required parameter 'version' is not null or undefined
            if (version === null || version === undefined) {
                throw new baseapi_1.RequiredError("version", "getSourcemaps");
            }
            // Path Params
            const localVarPath = "/api/v2/sourcemaps";
            // Make Request Context
            ...
            if (filename !== undefined) {
                requestContext.setQueryParam("filename", ObjectSerializer_1.ObjectSerializer.serialize(filename, "string", ""), "");
            }
            if (service !== undefined) {
                requestContext.setQueryParam("service", ObjectSerializer_1.ObjectSerializer.serialize(service, "string", ""), "");
            }
    ...
    listSourcemaps(mapkind, pageSize, pageNumber, filterService, filterVersion, filterVariant, filterId, filterBuildId, filterUuid, filterPlatform, filterBuildNumber, filterBundleName, filterArch, filterSymbolSource, filterOrigin, filterOriginVersion, filterFilename, filterDebugId, filterGnuBuildId, filterGoBuildId, filterFileHash, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listSourcemaps'");
    ...
    restoreSourcemaps(mapkind, dryRun, filterService, filterVersion, filterVariant, filterId, filterBuildId, filterUuid, filterPlatform, filterBuildNumber, filterBundleName, filterArch, filterSymbolSource, filterOrigin, filterOriginVersion, filterFilename, filterDebugId, filterGnuBuildId, filterGoBuildId, filterFileHash, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'restoreSourcemaps'");
            if (!_config.unstableOperations["v2.restoreSourcemaps"]) {
                throw new Error("Unstable operation 'restoreSourcemaps' is disabled");
            }
            // verify required parameter 'mapkind' is not null or undefined
            if (mapkind === null || mapkind === undefined) {
                throw new baseapi_1.RequiredError("mapkind", "restoreSourcemaps");
            }
            // verify required parameter 'dryRun' is not null or undefined
            if (dryRun === null || dryRun === undefined) {
                throw new baseapi_1.RequiredError("dryRun", "restoreSourcemaps");
            }
            // Path Params
...
class RUMApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteSourcemaps(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SourcemapsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getServiceRepositoryInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ServiceRepositoryInfoResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getSourcemaps(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SourcemapFileResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 404 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listSourcemaps(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListSourcemapsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
...
class RUMApi {
     ...
     * @param param The request object
     */
    deleteSourcemaps(param, options) {
     ...
     * @param param The request object
     */
    getServiceRepositoryInfo(param, options) {
     ...
     * @param param The request object
     */
    restoreSourcemaps(param, options) {
