...
class RumRetentionFiltersApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    getPermanentRetentionFilter(appId, permanentRfId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("appId", "getPermanentRetentionFilter");
            }
            // verify required parameter 'permanentRfId' is not null or undefined
            if (permanentRfId === null || permanentRfId === undefined) {
                throw new baseapi_1.RequiredError("permanentRfId", "getPermanentRetentionFilter");
            }
            // Path Params
    ...
    listPermanentRetentionFilters(appId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("appId", "listPermanentRetentionFilters");
            }
            // Path Params
            const localVarPath = "/api/v2/rum/applications/{app_id}/retention_filters/permanent".replace("{app_id}", encodeURIComponent(String(appId)));
            // Make Request Context
            const requestContext = _config
    ...
    updatePermanentRetentionFilter(appId, permanentRfId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("appId", "updatePermanentRetentionFilter");
            }
            // verify required parameter 'permanentRfId' is not null or undefined
            if (permanentRfId === null || permanentRfId === undefined) {
                throw new baseapi_1.RequiredError("permanentRfId", "updatePermanentRetentionFilter");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updatePermanentRetentionFilter");
            }
            // Path Params
            const localVarPath = "/api/v2/rum/applications/{app_id}/retention_filters/permanent/{permanent_rf_id}"
                .replace("{app_id}", encodeURIComponent(String(appId)))
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "RumPermanentRetentionFilterUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class RumRetentionFiltersApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getPermanentRetentionFilter(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "RumPermanentRetentionFilterResponse");
                return body;
            }
            if (response.httpStatusCode === 403 ||
                response.httpStatusCode === 404 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listPermanentRetentionFilters(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "RumPermanentRetentionFiltersResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updatePermanentRetentionFilter(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "RumPermanentRetentionFilterResponse");
...
class RumRetentionFiltersApi {
     ...
     * @param param The request object
     */
    getPermanentRetentionFilter(param, options) {
     ...
     * @param param The request object
     */
    listPermanentRetentionFilters(param, options) {
     ...
     * @param param The request object
     */
    updatePermanentRetentionFilter(param, options) {
